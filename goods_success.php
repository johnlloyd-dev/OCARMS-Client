                ...
                <div class="row justify-content-center">
                    ...
                    <?php 
                        ...
                        if (isset($_SESSION['donation_id'])) {
                            ...
                            $get_info = mysqli_query($conn, "SELECT * FROM `goods_donation` WHERE `donation_id`='$donation_id'");
                            $info = mysqli_fetch_assoc($get_info);
                    ?>
                    <div class="p-5 mb-2 bg-warning rounded-top text-dark-blue text-center drop bg-white">
                        <h3 class="font-weight-bold">Hello, <?php echo $info['profile_display'];?></h3>
                        <p>Your contact number is hereby necessary for contact purposes with regards on your goods donation. Please do understand.</p>
                    </div>
                    ...
                    <div class="row d-flex justify-content-center">
                            ...
                            <div class="pl-4 pr-4">
                                <div class="card">
                                    ...
                                    <div class="card-body text-dark-blue">
                                        ...
                                        <p class="text-success"><?=$info['profile_display'];?></p>
                                        <h6 class="text-dark-blue">Donation Date</h6>
                                        <p class="text-success"><?=$info['donation_date'];?></p>
                                        <h6 class="text-dark-blue">Contact Number</h6>
                                        <p class="text-success"><?=$user['client_contact_number'];?></p>
                                        <h6 class="text-dark-blue">Goods Classification</h6>
                                        <p class="text-success"><?=$info['goods_classification'];?></p>
                                        <h6 class="text-dark-blue">Pickup Location</h6>
                                        <p class="text-success"><?=$info['pickup_location'];?></p>
                                        <h6 class="text-dark-blue">Goods Description</h6>
                                        <p class="text-success text-justify"><?=$info['goods_description'];?></p>
                                        <h6 class="text-dark-blue">Status</h6>
                                        <p class="text-danger"><?=$info['donation_status'];?></p>
                                    </div>
                                </div>
                            </div>
                            <hr />
                                    ...
                                    <div class="container">
                                       <div class="row">
                                            <div class="col-lg-12 mb-3 text-center">
                                                <h6 class="text-dark-blue">Goods Image</h6>
                                                <img style="object-fit: cover;" width="250rem" height="260rem" src="includes/goods_donor/image_view.php?donation_id=<?=$donation_id;?>"/>
                                            </div>
                                        </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="card-body text-dark-blue">
                                        <div class="row">
                                            <div class="col-lg-12 mb-3">
                                                <p class="text-danger">The department will contact you any time soon with your provided contact number regarding on the additional details on your goods donation.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="pl-4 pr-4">
                                <div class="card">
                                    <div class="card-body text-dark-blue">
                                        <h6 class="text-dark-blue">PRINT YOUR DONATION INFO</h6>
